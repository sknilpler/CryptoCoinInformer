...
public class FormattingSymbol {
    ...
    private static final Set<String> baseCurrencies = new HashSet<>(Arrays.asList(
            ...
            "BCH", "XLM", "LINK", "ATOM", "UNI", "FIL", "ALGO", "VET", "FTM", "AVAX", "EGLD", "XTZ",
            "NEAR", "AAVE", "GRT", "SAND", "MANA", "THETA", "AXS", "KSM", "ZEC", "DASH", "COMP", "CRV",
            "SNX", "RUNE", "ENJ", "KAVA", "MKR", "YFI", "1INCH", "BAT", "CHZ", "HNT", "ICX", "ONT",
            "ZIL", "IOST", "WAVES", "QTUM", "ZRX", "LUNA", "CAKE", "XEC", "GALA", "CELO", "KLAY",
            "XNO", "LRC", "BTT", "STMX", "ANKR", "ROSE", "JASMY", "RSR", "KNC", "GNO", "ENS", "OMG",
            "FLOW", "INJ", "CRO", "RVN", "CSPR", "SUSHI", "XVG", "TWT", "CELR", "QNT", "DYDX", "NKN",
            "DGB", "LSK", "REP", "POLY", "STORJ", "RAY", "MINA", "GTC", "PYR", "SPELL", "LPT", "KEEP",
            "SRM", "OCEAN", "UMA", "BNT", "BAL", "ORN", "MTL", "KSM", "SKL", "REEF", "CTSI", "DENT"
    ));
    ...
    public static String formatSymbol(String symbol) {
        ...
        for (String base : baseCurrencies) {
            if (symbol.startsWith(base.toUpperCase())) {
                // Отделяем базовую валюту и оставшуюся котируемую валюту
